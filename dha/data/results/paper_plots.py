...
if __name__ == "__main__":
    ...
    layout_config = dict(
        ...
        xaxis=dict(
            title=dict(font=dict(size=desired_font_size)),  # Set desired font size for x-axis title
            tickfont=dict(size=desired_font_size-4),  # Set desired font size for x-axis
            tickformat='s'
            ),
        yaxis=dict(
            type="log",
            title=dict(font=dict(size=desired_font_size)),  # Set desired font size for y-axis title
